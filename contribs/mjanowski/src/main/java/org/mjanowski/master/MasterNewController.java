...
class MasterNewController extends AbstractController implements ControlerI {
	...
	private static Logger log = Logger.getLogger(MasterNewController.class);
	...
	//todo poprawić to żeby działało jak normalny newcontroller żeby były eventy controllera

	@Inject
	MasterNewController(Config config, ControlerListenerManagerImpl controlerListenerManager, MatsimServices matsimServices,
				 IterationStopWatch stopWatch, PrepareForSim prepareForSim, EventsHandling eventsHandling,
				 PlansDumping plansDumping, PlansReplanning plansReplanning, Mobsim masterSim,
